...
import { ALTERAR_TAREFA_API, CADASTRAR_TAREFA, OBTER_TAREFAS } from "@/store/tipo-acoes";
...
export const tarefa: Module<EstadoTarefa, Estado> = {
  ...
  actions: {
    ...
    [ALTERAR_TAREFA_API]({ commit }, tarefa: ITarefa) {
      return http.put(`/tarefas/${tarefa.id}`, tarefa).then(resposta => commit(ALTERA_TAREFA, resposta.data));
    },
  },
}